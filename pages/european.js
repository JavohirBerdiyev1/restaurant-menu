        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-gray-800 mb-4">
              🍝 {menuCategories.find(c => c.id === 'european')?.name[currentLang]}
            </h1>
            <p className="text-gray-600 text-lg">
              {currentLang === 'uz' ? 'Yevropa oshxonasining eng mazali taomları' : 
               currentLang === 'ru' ? 'Самые вкусные блюда европейской кухни' : 
               'The most delicious dishes of European cuisine'}
            </p>
          </div>
          ...
          {categories.map((category) => (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {europeanDishes[category.id]?.map((dish) => (
